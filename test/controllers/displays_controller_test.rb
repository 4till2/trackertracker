...
class DisplaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create display" do
    assert_difference("Display.count") do
      post displays_url, params: { display: { dashboard_id: @display.dashboard_id, type: @display.type } }
    end
  ...
  test "should update display" do
    patch display_url(@display), params: { display: { dashboard_id: @display.dashboard_id, type: @display.type } }
